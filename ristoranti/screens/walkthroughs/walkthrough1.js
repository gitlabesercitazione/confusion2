...
export class Walkthrough1 extends React.Component {
  ...
  render() {
    ...
    */
    ...
    image_quality = <Image style={{ resizeMode: 'contain', height: height_sub, width: width_sub ,marginTop: 150 }} source={require('../../assets/ristoranti-sul-mare01.jpg')}/> ;
    return (
      <View style={styles.screen}>
        {/* {image} */}
        {image_quality}
        <RkText rkType='header2' style={styles.text}>Scegli il ristorante</RkText>
      </View>
    )
  }
}
