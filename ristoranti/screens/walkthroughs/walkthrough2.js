...
export class Walkthrough2 extends React.Component {
  ...
  render() {
    ...
    */
    ...
    image_quality = <Image style={{ resizeMode: 'contain', height: height_sub, width: width_sub ,marginTop: 150}} source={require('../../assets/images/MessagesRed.png')}/> ;
    return (
      <View style={styles.screen}>
        {/* {image} */}
        {image_quality}
        <RkText rkType='header2' style={styles.text}>Richiedi una prenotazione</RkText>
      </View>
    )
  }
}
